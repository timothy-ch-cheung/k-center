...
\Function{Local\textunderscore Search}{$V,C, k$}
    \Repeat
        ...
        \For{$v_i\in C$}
            ...
            \State {best\textunderscore cv$\gets$ count\textunderscore cv($C$, Cost($C$))}
            \For{$v_j\in V\setminus C$}
                ...
                \ElsIf {best\textunderscore flip != undefined \textbf{and} count\textunderscore cv($\bar{C}$, Cost($\bar{C}$))$<$best\textunderscore cv}
                    \State {best\textunderscore cv$\gets$ count\textunderscore cv($\bar{C}$, Cost($\bar{C}$))}
                    \State {best\textunderscore cv\textunderscore flip$\gets j$}
                \EndIf
            \EndFor
