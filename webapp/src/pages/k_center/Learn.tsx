...
import ck_center_task from "../../assets/3b_colourful_task.png"
import ck_center_solution from "../../assets/3c_colourful_solution.png"
...
function Learn() {
    ...
    const slides: Array<Slide> = [
        {
            img: k_center_initial, title: "What is the k-center problem?", description: `Imagine you were planning a city 
        with a parcel delivery network and the n points represent potential locations for residents or warehouses. 
        ...
        them such the the distance that a delivery driver must travel is minimised? Alternatively where should 
        warehouses be built such that the maximum distance between a resident and their nearest warehouse is 
        minimised?`
        },
        {
            img: k_center_task, title: "What is the k-center problem?", description: `What if the budget was limited
        ...
        {
            img: ck_center_label, title: "Taking prior knowledge into account", description: `Assume we know that 
            people aged over 60 tend to live in the countryside and they are more likely to require an ambulance. The
            robust k-center problem would exclude them even though they need the service more.`
        },
        {
