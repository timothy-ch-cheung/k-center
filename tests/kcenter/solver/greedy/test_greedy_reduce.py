...
def test_generator_greedy_basic_graph_outlier_colourful_clustering():
    ...
    assert next(solution) == (
        {0: {0, 1, 2}, 4: {3, 4}}, pytest.approx(0.707, FLOAT_ERROR_MARGIN), 'decrease weight to 0.707')
    assert next(solution) == ({0: {0, 1, 2}, 4: {3, 4}}, pytest.approx(0.707, FLOAT_ERROR_MARGIN),
